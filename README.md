...
The purpose of this project is to build a deeper understanding of Swift Concurrency by implementing and comparing multiple approaches to the same problem.

Rather than focusing only on building an image gallery app, this repository approaches concurrency as a learning experiment inside an application context.

Through a series of isolated feature tabs, this project aims to:

- visualize the difference between sequential and parallel execution
- observe where suspension and cancellation affect UI behavior
- understand how actors manage shared state safely
- make concurrency code testable through dependency injection
- build intuition for Swift Concurrency through direct implementation and verification

By documenting these findings and supporting them with tests, this repository serves as both a learning record and a practical reference for studying Swift Concurrency and Swift Testing in iOS development.
